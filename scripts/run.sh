...
function run_odom {
    ...
    cd $kobuki_ws_dir
    docker compose run $1 --rm kobuki-ws /home/user/kobuki_ws/script/kobuki-bringup.sh
}
...
function run_lidar {
    ...
    cd $lidar_ws_dir
    docker compose run $1 --rm vlplidar-ws /home/user/vlplidar_ws/scripts/lidar-bringup.sh
}
...
function run_realsense {
    ...
    cd $realsense_ws_dir
    docker compose run $1 --rm realsense-ros1-ws /home/user/realsense_ros1_ws/scripts/realsense-bringup.sh
}

function run_nav {
    # Run navigation node
    cd $kobuki_ws_dir
    docker compose run $1 --rm kobuki-ws /home/user/kobuki_ws/script/nav-bringup.sh
}
